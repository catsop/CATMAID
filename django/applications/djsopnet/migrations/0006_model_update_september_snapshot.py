...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djsopnet_viewproperties', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assembly', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'])),
        ...
        db.send_create_signal(u'djsopnet', ['ViewProperties'])


    def backwards(self, orm):
        # Deleting model 'ViewProperties'
        db.delete_table(u'djsopnet_viewproperties')
