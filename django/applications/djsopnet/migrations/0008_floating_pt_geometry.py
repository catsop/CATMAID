...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SliceHole.shape_y'
        db.alter_column(u'djsopnet_slicehole', 'shape_y', self.gf('catmaid.fields.FloatArrayField')())

        # Changing field 'SliceHole.shape_x'
        db.alter_column(u'djsopnet_slicehole', 'shape_x', self.gf('catmaid.fields.FloatArrayField')())

        # Changing field 'Slice.shape_y'
        db.alter_column(u'djsopnet_slice', 'shape_y', self.gf('catmaid.fields.FloatArrayField')())

        # Changing field 'Slice.min_y'
        db.alter_column(u'djsopnet_slice', 'min_y', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Slice.max_y'
        db.alter_column(u'djsopnet_slice', 'max_y', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Slice.shape_x'
        db.alter_column(u'djsopnet_slice', 'shape_x', self.gf('catmaid.fields.FloatArrayField')())

        # Changing field 'Slice.min_x'
        db.alter_column(u'djsopnet_slice', 'min_x', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Slice.max_x'
        db.alter_column(u'djsopnet_slice', 'max_x', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'SliceHole.shape_y'
        db.alter_column(u'djsopnet_slicehole', 'shape_y', self.gf('catmaid.fields.IntegerArrayField')())

        # Changing field 'SliceHole.shape_x'
        db.alter_column(u'djsopnet_slicehole', 'shape_x', self.gf('catmaid.fields.IntegerArrayField')())

        # Changing field 'Slice.shape_y'
        db.alter_column(u'djsopnet_slice', 'shape_y', self.gf('catmaid.fields.IntegerArrayField')())

        # Changing field 'Slice.min_y'
        db.alter_column(u'djsopnet_slice', 'min_y', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Slice.max_y'
        db.alter_column(u'djsopnet_slice', 'max_y', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Slice.shape_x'
        db.alter_column(u'djsopnet_slice', 'shape_x', self.gf('catmaid.fields.IntegerArrayField')())

        # Changing field 'Slice.min_x'
        db.alter_column(u'djsopnet_slice', 'min_x', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Slice.max_x'
        db.alter_column(u'djsopnet_slice', 'max_x', self.gf('django.db.models.fields.IntegerField')())
