...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assembly.stack'
        db.add_column(u'djsopnet_assembly', 'stack',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catmaid.Stack']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assembly.stack'
        db.delete_column(u'djsopnet_assembly', 'stack_id')
