...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SliceHoleRelation'
        db.create_table(u'djsopnet_sliceholerelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('external', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Slice'])),
            ('internal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.SliceHole'])),
        ))
        db.send_create_signal(u'djsopnet', ['SliceHoleRelation'])

        # Adding model 'SliceHole'
        db.create_table(u'djsopnet_slicehole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shape_x', self.gf('catmaid.fields.IntegerArrayField')()),
            ('shape_y', self.gf('catmaid.fields.IntegerArrayField')()),
        ))
        db.send_create_signal(u'djsopnet', ['SliceHole'])


    def backwards(self, orm):
        # Deleting model 'SliceHoleRelation'
        db.delete_table(u'djsopnet_sliceholerelation')

        # Deleting model 'SliceHole'
        db.delete_table(u'djsopnet_slicehole')
