...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SliceHole.assembly'
        db.add_column(u'djsopnet_slicehole', 'assembly',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['djsopnet.Assembly']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SliceHole.assembly'
        db.delete_column(u'djsopnet_slicehole', 'assembly_id')
