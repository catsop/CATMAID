...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeatureName.name'
        db.alter_column(u'djsopnet_featurename', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'FeatureName.name'
        db.alter_column(u'djsopnet_featurename', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
