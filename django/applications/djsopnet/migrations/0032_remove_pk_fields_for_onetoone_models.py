...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SegmentFeatures.id'
        db.delete_column(u'djsopnet_segmentfeatures', u'id')


        # Changing field 'SegmentFeatures.segment'
        #db.alter_column(u'djsopnet_segmentfeatures', 'segment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djsopnet.Segment'], unique=True, primary_key=True))
        db.execute('''
            ALTER TABLE djsopnet_segmentfeatures
            ADD CONSTRAINT djsopnet_segmentfeatures_pkey PRIMARY KEY (segment_id);
            ALTER TABLE djsopnet_segmentfeatures
            DROP CONSTRAINT djsopnet_segmentfeatures_segment_id_key;
            ''')
        # Deleting field 'SolutionPrecedence.id'
        db.delete_column(u'djsopnet_solutionprecedence', u'id')


        # Changing field 'SolutionPrecedence.core'
        #db.alter_column(u'djsopnet_solutionprecedence', 'core_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djsopnet.Core'], unique=True, primary_key=True))
        db.execute('''
            ALTER TABLE djsopnet_solutionprecedence
            ADD CONSTRAINT djsopnet_solutionprecedence_pkey PRIMARY KEY (core_id);
            ALTER TABLE djsopnet_solutionprecedence
            DROP CONSTRAINT djsopnet_solutionprecedence_core_id_key;
            ''')

    def backwards(self, orm):
        # Changing field 'SegmentFeatures.segment'
        #db.alter_column(u'djsopnet_segmentfeatures', 'segment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['djsopnet.Segment'], unique=True))
        db.execute('''
            ALTER TABLE djsopnet_segmentfeatures
            ADD CONSTRAINT djsopnet_segmentfeatures_segment_id_key UNIQUE (segment_id);
            ALTER TABLE djsopnet_segmentfeatures
            DROP CONSTRAINT djsopnet_segmentfeatures_pkey;
            ''')

        # Adding field 'SegmentFeatures.id'
        # db.add_column(u'djsopnet_segmentfeatures', u'id',
        #               self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute('''
            ALTER TABLE "djsopnet_segmentfeatures" ADD COLUMN "id" serial NOT NULL PRIMARY KEY;
            ''')

        # Changing field 'SolutionPrecedence.core'
        #db.alter_column(u'djsopnet_solutionprecedence', 'core_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Core'], unique=True))
        db.execute('''
            ALTER TABLE djsopnet_solutionprecedence
            ADD CONSTRAINT djsopnet_solutionprecedence_core_id_key UNIQUE (core_id);
            ALTER TABLE djsopnet_solutionprecedence
            DROP CONSTRAINT djsopnet_solutionprecedence_pkey;
            ''')

        # Adding field 'SolutionPrecedence.id'
        # db.add_column(u'djsopnet_solutionprecedence', u'id',
        #               self.gf('django.db.models.fields.AutoField')(primary_key=True))
        db.execute('''
            ALTER TABLE "djsopnet_solutionprecedence" ADD COLUMN "id" serial NOT NULL PRIMARY KEY;
            ''')
    ...
    models = {
        ...
        u'djsopnet.segmentfeatures': {
            ...
            'segment': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['djsopnet.Segment']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        u'djsopnet.solutionprecedence': {
            ...
            'core': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['djsopnet.Core']", 'unique': 'True', 'primary_key': 'True'}),
