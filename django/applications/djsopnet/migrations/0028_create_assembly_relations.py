...
from djsopnet.fields import AssemblyRelationEnumField


class Migration(SchemaMigration):

    def forwards(self, orm):
        db.execute('CREATE TYPE assemblyrelation AS ENUM (' + \
             ','.join([("'%s'" % v[0]) for v in AssemblyRelationEnumField.enum_choices]) + ')')
    ...
    def backwards(self, orm):
        ...
        db.execute('DROP TYPE assemblyrelation')
