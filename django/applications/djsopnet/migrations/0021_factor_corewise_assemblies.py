...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Segment.assembly'
        db.delete_column(u'djsopnet_segment', 'assembly_id')

        # Deleting field 'Assembly.name'
        db.delete_column(u'djsopnet_assembly', 'name')

        # Deleting field 'Assembly.assembly_type'
        db.delete_column(u'djsopnet_assembly', 'assembly_type')

        # Adding field 'Assembly.equivalence'
        db.add_column(u'djsopnet_assembly', 'equivalence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.AssemblyEquivalence'], null=True),
                      keep_default=False)

        # Adding field 'SegmentSolution.assembly'
        db.add_column(u'djsopnet_segmentsolution', 'assembly',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'], null=True),
                      keep_default=False)

        # Deleting field 'Slice.assembly'
        db.delete_column(u'djsopnet_slice', 'assembly_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Segment.assembly'
        db.add_column(u'djsopnet_segment', 'assembly',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'], null=True),
                      keep_default=False)

        # Adding field 'Assembly.name'
        db.add_column(u'djsopnet_assembly', 'name',
                      self.gf('django.db.models.fields.CharField')(default='UNKNOWN', max_length=255),
                      keep_default=False)

        # Adding field 'Assembly.assembly_type'
        db.add_column(u'djsopnet_assembly', 'assembly_type',
                      self.gf('django.db.models.fields.CharField')(default='neuron', max_length=32, db_index=True),
                      keep_default=False)

        # Deleting field 'Assembly.equivalence'
        db.delete_column(u'djsopnet_assembly', 'equivalence_id')

        # Deleting field 'SegmentSolution.assembly'
        db.delete_column(u'djsopnet_segmentsolution', 'assembly_id')

        # Adding field 'Slice.assembly'
        db.add_column(u'djsopnet_slice', 'assembly',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'], null=True),
                      keep_default=False)
