...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djsopnet_assembly', (
            ...
            ('assembly_type', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('djsopnet', ['Assembly'])


        # Changing field 'Segment.assembly'
        db.alter_column('djsopnet_segment', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'], null=True))

        # Changing field 'Slice.assembly'
        db.alter_column('djsopnet_slice', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djsopnet.Assembly'], null=True))

    def backwards(self, orm):
        # Deleting model 'Assembly'
        db.delete_table('djsopnet_assembly')


        # Changing field 'Segment.assembly'
        db.alter_column('djsopnet_segment', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.ClassInstance'], null=True))

        # Changing field 'Slice.assembly'
        db.alter_column('djsopnet_slice', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.ClassInstance'], null=True))
