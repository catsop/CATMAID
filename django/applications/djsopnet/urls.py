...
urlpatterns = patterns('djsopnet.views',
    ...
    # Tests
    (r'^segmentguarantor/(?P<project_id>\d+)/(?P<stack_id>\d+)/(?P<x>\d+)/(?P<y>\d+)/(?P<z>\d+)/test$',
            'test_segmentguarantor_task'),
    (r'^sliceguarantor/(?P<project_id>\d+)/(?P<stack_id>\d+)/(?P<x>\d+)/(?P<y>\d+)/(?P<z>\d+)/test$',
            'test_sliceguarantor_task'),
    (r'^solutionguarantor/(?P<project_id>\d+)/(?P<stack_id>\d+)/(?P<x>\d+)/(?P<y>\d+)/(?P<z>\d+)/test$',
