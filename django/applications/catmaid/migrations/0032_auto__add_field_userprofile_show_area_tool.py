...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_area_tool'
        db.add_column(u'catmaid_userprofile', 'show_area_tool',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_area_tool'
        db.delete_column(u'catmaid_userprofile', 'show_area_tool')
    ...
    models = {
        ...
        u'catmaid.userprofile': {
            ...
            'show_area_tool': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
